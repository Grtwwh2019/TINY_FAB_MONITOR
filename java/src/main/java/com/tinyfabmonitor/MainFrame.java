    ...
    private static class AnalysisTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int column) {
            ...
            switch (column) {
                ...
                case 4: return m.confidence; case 5: return UiFormat.dateTime(m.completedAt); case 6: return baselineCompletion(m);
                case 7: return signed(m.readinessClockDeltaSeconds); case 8: return m.keyDelayedDependency;
                case 9: return m.waitReason; case 10: return m.primaryThreadBlocker; case 11: return duration(m.threadBlockedSeconds);
                case 12: return signed(m.executionDeltaSeconds); case 13: return signed(m.waitDeltaSeconds);
                case 14: return signed(m.readyToCompleteDeltaSeconds); case 15: return signed(m.completionDelaySeconds);
                case 16: return UiFormat.duration(m.delayContributionSeconds); default: return m.reason;
            }
        }
